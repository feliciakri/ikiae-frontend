		...
		<>
			<div>
				<button
					...
					className="z-10 inline-flex items-center justify-center w-10 h-10 mr-2 text-gray-700 transition-colors duration-150 bg-white rounded-full focus:shadow-outline hover:bg-gray-200"
				>
						...
						<div className="fixed inset-y-0 right-0 pl-10 max-w-full flex">
							...
							>
								<div className="w-screen max-w-md">
									<div className="h-full flex flex-col z-40 bg-white shadow-xl overflow-y-scroll">
